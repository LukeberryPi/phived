          ...
          return (
            <li
              ...
              className={`group flex ${
                isBeingDragged &&
                "overflow-hidden rounded-2xl border-l border-t border-black/30 dark:border-trueWhite/30"
              }`}
              ...
              <span
                ...
                className={`${
                  ...
                  isBeingDragged
                    ? "border-b border-black/30 dark:border-trueWhite/30"
                    : "hidden"
                } group/drag flex items-center justify-center bg-trueWhite pr-2 text-black placeholder:select-none
                hover:cursor-grab dark:bg-zinc-950 dark:text-trueWhite sm:text-lg`}
              >
              ...
              <button
                ...
                className={`${isFirstTask && "rounded-tr-2xl"} ${
                  ...
                  isBeingDragged
                    ...
                    : "hidden"
                } group/done select-none items-center justify-center border-b border-l border-black bg-teal-300 px-4 dark:border-trueWhite dark:bg-dailyPurple dark:text-trueWhite xs:px-6 sm:text-lg`}
              >
  ...
  return (
    <section className="flex flex-col items-center gap-4">
      <div className="flex flex-col gap-2 text-center">
        <p className="mx-auto w-fit rounded-lg bg-teal-300 px-3 py-1 text-sm dark:bg-dailyPurple dark:text-trueWhite sm:text-base">
          daily
        </p>
      ...
      {!noDailyTasks && (
        <ul
          ...
          className="w-[300px] resize-x overflow-hidden rounded-2xl border border-black shadow-brutalist-dark dark:border-trueWhite dark:shadow-brutalist-light tiny:w-80 xs:w-96"
        >
          <DragDropContext
      ...
      {!!showImpossibleToRegenerateTasks && (
        <div className="group flex items-center gap-3 text-black dark:text-trueWhite">
          <Light size={24} />
      ...
      {dailyTasksLastDoneAt.length > 0 &&
        ...
        !dailyMessage && (
          ...
          >
            <CounterClockWise className="text-black dark:text-trueWhite" />
            <span className="text-black dark:text-trueWhite">{`restore ${
