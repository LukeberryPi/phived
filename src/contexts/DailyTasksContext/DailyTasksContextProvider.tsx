...
export const DailyTasksContextProvider = ({ children }: PropsWithChildren) => {
  ...
  const clearDailyTasks = useCallback(() => {
    const isUserCertain = window.confirm(
      "Are you sure you want to DELETE all your daily tasks? You will be unable to regenerate the tasks you have already done and will begin from a clean slate."
    );
